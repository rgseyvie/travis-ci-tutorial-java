[![Build Status](https://app.travis-ci.com/rgseyvie/travis-ci-tutorial-java.svg?branch=master)](https://app.travis-ci.com/joaomlneto/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/rgseyvie/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/joaomlneto/travis-ci-tutorial-java)
...
3. Fix the `README.md` badges (replacing in the URL `rgseyvie` with `your-github-username`) and push the changes. This should trigger a build in Travis CI!
